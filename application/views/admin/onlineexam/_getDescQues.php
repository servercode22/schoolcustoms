...
<div class="font-weight-bold"> <?php echo $this->lang->line('attachment')?>: <a href="<?php echo site_url('admin/onlineexam/downloadattachment/'.$result_item->attachment_upload_name); ?>"><?php echo $result_item->attachment_name;?> <i class="fa fa-download"></i></a></div>
  <?php
}
 ?>
