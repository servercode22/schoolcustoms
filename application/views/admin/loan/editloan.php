            ...
            if ($this->rbac->hasPrivilege('loan_management', 'can_add')) {
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <form id="form1" action=<?php echo site_url("admin/loan/edit/".$editdata->id) ?>  id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            <div class="box-body">
                            <?php if ($this->session->flashdata('msg')) { ?>
                                ...
                                <?php foreach ($roletype as $rolekey => $rolevalue) {
                                    ?>
                                    <option value="<?php echo $rolevalue["id"] ?>"<?php
                                 if (set_value('role_id',$editdata->role_id) == $rolevalue['id']) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control date"  value="<?php echo $editdata->date ?>" readonly="readonly" />
                                    <span class="text-danger"><?php echo form_error('date'); ?></span>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('loanamount'); ?><small class="req"> *</small></label>
                                    <input id="amount" name="amount" placeholder="" type="text" class="form-control"  value="<?php echo $editdata->loan_amount?>" />
                                ...
                                <div class="form-group" id="amountfix">
                                     ...
                                     <input type="number" id="fix_amount" class = "form-control" value = "<?php echo $editdata->deduct_amount?>" name = "fix_amount">
                                 </div>
                                 <div class="form-group" id="amountpercentage">
                                     <label for="">Enter Percentage</label><small class="req"> *</small>
                                     <input type="number" class = "form-control" value = "<?php echo $editdata->loan_percentage?>" name="percentage_amount">
                                 </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1"><?php echo $this->lang->line('description'); ?></label>
                                    <textarea class="form-control" id="description" name="description" placeholder="<?php echo $editdata->description?>" rows="3" placeholder="Enter ..."><?php echo set_value('description'); ?></textarea>
