			...
			<div class="col-md-12">
				<div class="box removeboxmius">
					...
					<div class="box-body">
						...
						<form role="form" action="<?php echo site_url('admin/payroll/deductionreport') ?>" method="post" class="">
										...
										<div class="form-group">
											...
											<select name="deduction" class="form-control">
												<option value=""><?php
																	...
																	?></option>
												<?php foreach ($deductions as $yearkey => $deduction) { ?>
													<option <?php
															if (($deduction == $deduction["name"])) {
																echo "selected";
															}
															?> value="<?php echo $deduction["name"]; ?>"><?php echo $deduction["name"]; ?></option>
												<?php } ?>
											</select>
										...
										<table class="table table-striped table-bordered table-hover example table-fixed-header">
											<thead class="header">
												<tr>
													...
													<th class="text text-right"><?php echo $this->lang->line('deduction'); ?> type <span><?php echo "(" . $currency_symbol . ")"; ?></span></th>
