			...
			<div class="col-md-12">
				<div class="box removeboxmius">
					...
					<div class="box-body">
						...
						<form role="form" action="<?php echo site_url('report/deduction_report') ?>" method="post" class="">
							...
							<div class="box-body table-responsive">
								<div class="tab-content">
									<div class="tab-pane active table-responsive" id="tab_parent">
										<div class="download_label"><?php echo $this->lang->line('deduction'); ?> <?php echo $this->lang->line('report_for') . "<br>";
												...
												?>
													...
													?>
														<tr>
															...
															<td><?php echo $value['allowance_type'] ?></td>
													...
													<tr class="box box-solid total-bg">
														...
														<td class="text text-right"><?php echo ($currency_symbol . number_format($deductions, 2, '.', '')); ?></td>
